void http_GET() {
  ...
  server.on("/get", HTTP_GET, [] (AsyncWebServerRequest * request) {
    ...
    // GET inputPasswort value on <ESP_IP>/get?inputPasswort=<inputMessage>
    ...
    // GET inputhomeeIP value on <ESP_IP>/get?inputhomeeIP=<inputMessage>
    ...
    // GET inputName1 value on <ESP_IP>/get?inputName1=<inputMessage>
    ...
    // GET inputId1 value on <ESP_IP>/get?inputId1=<inputMessage>
    ...
    // GET inputAttr1 value on <ESP_IP>/get?inputAttr1=<inputMessage>
    ...
    // GET inputName2 value on <ESP_IP>/get?inputName2=<inputMessage>
    ...
    // GET inputId2 value on <ESP_IP>/get?inputId2=<inputMessage>
    ...
    // GET inputAttr2 value on <ESP_IP>/get?inputAttr2=<inputMessage>
    ...
    // GET inputName3 value on <ESP_IP>/get?inputName3=<inputMessage>
    ...
    // GET inputId3 value on <ESP_IP>/get?inputId3=<inputMessage>
    ...
    else if (request->hasParam(UI_debug)) {
      inputMessage = request->getParam(UI_debug)->value();
      preferences.begin ( NAME, false ) ;                 // Open for read/write
      preferences.putString ("debug", inputMessage);
      preferences.end();
      debug = inputMessage;
    }
    else {

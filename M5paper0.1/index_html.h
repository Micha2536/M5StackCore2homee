/*BY SteffenTM und Micha homee Community
 * 
 * 
 */
...
String UI_verbindungsart = "verbindungsart";
String UI_mqttip = "inputMqttIp";
String UI_mqttport = "inputMqttPort";
...
<!DOCTYPE HTML><html style="background-color:dimgrey"><head>
  <title>M5Paper Konfiguration</title>
  <html lang="de">
  <meta charset="utf-8">
...
<h1 style="color:darkblue;font-size:50px;"><strong>M5Paper</strong></h1>
...
<form action="/get" target="hidden-form">
 <label for="verbindungsart"><strong>Verbindungsart %verbindungsart%</strong></label><br>
 <input list="verb" id="verbindungsart" name="verbindungsart" placeholder="MQTT/WebSocket/Webhook" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <datalist id="verb">
  <option value="MQTT">
...
<form action="/get" target="hidden-form" >
  <label for="inputhomeeIP"><strong>Websocket / Webhook homee %inputhomeeIP%</strong></label><br>
  <input type="text" name="inputhomeeIP" placeholder="homeeIP" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="text" name="inputToken" placeholder="Token" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="text" name="inputWebhook" placeholder="Webhookkey" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="submit" value="Speichern" onclick="submitMessage()"><br>
</form><br>
<form action="/get" target="hidden-form" >
  <label for="inputmqtt"><strong>MQTT Server %inputMqttIp% %inputMqttPort%</strong></label><br>
  <input type="ip" name="inputMqttIp" placeholder="Mqtt IP" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="text" name="inputMqttPort" placeholder="Mqtt Port" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="submit" value="Speichern" onclick="submitMessage()"><br>
</form><br>
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr1" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="number" name="inputId1" placeholder="Node-ID / HG-ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
   <input list="hg1" id="inputHg1" name="inputHg1" placeholder="true/false" value="false" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <datalist id="hg1">
  <option value="true">
  <option value="false">
</datalist>
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr2" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr3" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr4" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr5" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputAttr6" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
...
<form action="/get" target="hidden-form" >
  ...
  <input type="number" name="inputTempOut" placeholder="Attribut ID" style="background-color:lightgrey; color:darkblue; font-size:15px;">
  <input type="submit" value="Speichern" onclick="submitMessage()"><br>
</form><br>
<form action="/get" target="hidden-form" >
...
String processor(const String& var) {
  ...
  else if (var == "verbindungsart") {
    preferences.begin (NAME, false);
    return preferences.getString ("verbindungsart");
    preferences.end();
    Serial.print(preferences.getString ("verbindungsart"));
  }
  else if (var == "inputMqttPort") {
    preferences.begin (NAME, false);
    return preferences.getString ("mqttport");
    preferences.end();
    Serial.print(preferences.getString ("mqttport"));
  }
  else if (var == "inputMqttIp") {
    preferences.begin (NAME, false);
    return preferences.getString ("mqttip");
    preferences.end();
    Serial.print(preferences.getString ("mqttip"));
  }
  return String();
}
